        ...
        <div className="">
          ...
          {props.suggestedCities.map(({ city, country }, index) => (
              ...
              onClick={() => {
                ...
                key={index}
                className={`${props.darkMode ? "bg-slate-900 text-white hover:bg-slate-700":"bg-slate-300 text-black hover:bg-gray-400"} cursor-pointer h-7 last:pb-4 flex items-center px-4 p-3 last:rounded-b-2xl w-[30rem] last`}
                >
              <li>
                {city}, {country}
              </li>
